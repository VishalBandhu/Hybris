 ...
 */
package com.mindtree.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("mindtreecockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("mindtreecockpits.product.externalTaxes"));
