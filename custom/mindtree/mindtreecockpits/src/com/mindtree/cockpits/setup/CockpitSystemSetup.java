 ...
 */
package com.mindtree.cockpits.setup;
...
import com.mindtree.cockpits.constants.MindtreeCockpitsConstants;
 ...
 */
@SystemSetup(extension = MindtreeCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MindtreeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MindtreeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MindtreeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/mindtreecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
