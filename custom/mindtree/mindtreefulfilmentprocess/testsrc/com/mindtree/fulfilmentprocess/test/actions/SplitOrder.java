 ...
 */
package com.mindtree.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MindtreeFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MindtreeFulfilmentProcessConstants.PARENT_PROCESS);
