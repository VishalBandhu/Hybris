 ...
 */
package com.mindtree.core.constants;

/**
 * Global class for all MindtreeCore constants. You can add global constants for your extension into this class.
 */
public final class MindtreeCoreConstants extends GeneratedMindtreeCoreConstants
{
	public static final String EXTENSIONNAME = "mindtreecore";


	private MindtreeCoreConstants()
	{
		//empty
	}
