 ...
 */
package com.mindtree.test.setup;
...
import com.mindtree.test.constants.MindtreeTestConstants;
import com.mindtree.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MindtreeTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mindtreetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mindtreetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mindtreetest/import/cstickets.impex");
			...
			importImpexFile(context, "/mindtreetest/import/csquotes.impex");
		}
	}
}
